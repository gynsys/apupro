...
async def export_apu_googlesheet(item_id: str, db: Session = Depends(get_db)):
    """
    Exporta un APU a Google Sheets con fÃ³rmulas y formato.
    ...
    try:
        ...
        header_data = [
            ...
            ["CÃ³digo:", item.CovPar or item.CodPar, "", "Unidad:", item.UniPar, "", "Rendimiento:", rendimiento],
            [],  # Fila vacÃ­a
            ["1. MATERIALES"],
            ["No.", "DescripciÃ³n", "Und.", "Cant.", "Desp.", "Precio", "Total"],
        ]
        ...
        # Equipos
        header_data.append([], ["2. EQUIPOS"], ["No.", "DescripciÃ³n", "", "Cant.", "Cop/Dep", "Precio", "Total"])
        ...
        # Mano de Obra
        header_data.append([], ["3. MANO DE OBRA"], ["No.", "DescripciÃ³n", "Cant.", "Jornal", "Bono", "Total Jornal", "Total Bono"])
        ...
        header_data.append([f"AdministraciÃ³n y Gastos ({admin_gg}%):", "", "", "", "", "", f"=R[-1]C*{admin_gg/100}"])
