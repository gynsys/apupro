...
// AJUSTAR: Importa CatalogResourceTab desde la ruta correcta
import CatalogResourceTab from '../components/CatalogResourceTab'; // placeholder
...
const CatalogTab = ({ title, resourceType, selectedDatabase, config }) => {
  ...
  return (
    <>
      ...
      {/* AJUSTAR: Integra tu CatalogResourceTab real aqui */}
      <CatalogResourceTab
