...
export const AdminHeader = ({ showDashboardButton = true, onMenuClick, doctor, isDarkTheme }) => {
  ...
  return (
    <header className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm sticky top-0 z-50 transition-colors duration-200 pt-safe">
        ...
        <div className="flex justify-between items-center h-14 sm:h-16">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            {onMenuClick && (
              <button
                onClick={onMenuClick}
                className="p-2 rounded-xl text-gray-500 hover:text-gray-700 hover:bg-gray-100 focus:outline-none touch-target flex items-center justify-center transition-all cursor-pointer"
