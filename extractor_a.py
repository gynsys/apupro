...
pdf_path = r'C:\Users\pablo\Documents\Partidas_A.pdf'
salida = r'C:\Users\pablo\Documents\partidas_A.json'
...
with pdfplumber.open(pdf_path) as pdf:
    ...
    for i, p in enumerate(pdf.pages):
        ...
        apu_data = {
            "materials": [i for i in insumos if i["tipo"] == "Material"],
            "equipments": [i for i in insumos if i["tipo"] == "Equipo"],
            "labor": [i for i in insumos if i["tipo"] == "Mano de Obra"]
        }
...
print(f"LISTO! {len(datos_json)} partidas de la base A extraidas en {time.time() - t0:.1f}s")
